...
class Conv2dTime(nn.Conv2d):
    ...
    def forward(self, t, x):
        ...
        # Time tensor shaped like the input feature and is concatenated along dimension 1 that is as an extra channel to the input feature
        t_img = torch.ones_like(x[:, :1, :, :]) * t 

        # Shape (batch_size, channels + 1, height, width)
        # Concatenated feature with one extra channel for the time tensor
